...
public class GridBagLayoutFrame extends JFrame {
	...
	private DefaultListModel<Object> leftModel = new DefaultListModel<Object>();
	private DefaultListModel<Object> rightMOdel = new DefaultListModel<Object>();
	private JList<Object> leftList = new JList<Object>(leftModel);
	private JList<Object> rightList = new JList<Object>(rightMOdel);
	...
	private void addItem() {
		if (field.getText() != null && !field.getText().equals("")) {
			((DefaultListModel<Object>) leftList.getModel()).addElement(field.getText());
			field.setText("");
		}
	}
	...
	private void leftItem() {
		if (rightList.getSelectedIndex() != -1) {
			...
			((DefaultListModel<Object>) rightList.getModel()).remove(rightList.getSelectedIndex());
			((DefaultListModel<Object>) leftList.getModel()).addElement(o);
		}
	}
	...
	private void rightItem() {
		if (leftList.getSelectedIndex() != -1) {
			...
			((DefaultListModel<Object>) leftList.getModel()).remove(leftList.getSelectedIndex());
			((DefaultListModel<Object>) rightList.getModel()).addElement(o);
		}
	}
