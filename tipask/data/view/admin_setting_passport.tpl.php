...
<td class="altbg2">
<input class="radio"  type="radio"  <? if(1==$setting['passport_open'] ) { ?>checked<? } ?>  value="1" name="passport_open" ><label for="yes">开启</label>
<input class="radio"  type="radio"  <? if(0==$setting['passport_open'] ) { ?>checked<? } ?> value="0" name="passport_open" ><label for="no">关闭</label>
</td>
</tr>
<tr>
...
<td class="altbg2">
<input class="radio"  type="radio"  <? if(1==$setting['passport_type'] ) { ?>checked<? } ?>  value="1" name="passport_type" onclick="javascript:$('#hidden1').style.display = '';$('#hidden2').style.display = 'none';"><label for="yes">服务器端</label>&nbsp;
<input class="radio"  type="radio"  <? if(0==$setting['passport_type'] ) { ?>checked<? } ?> value="0" name="passport_type" onclick="javascript:$('#hidden1').style.display = 'none';$('#hidden2').style.display = '';"><label for="no">客户端</label>
</td>
</tr>
<tbody id="hidden1" <? if(0==$setting['passport_type'] ) { ?> style="DISPLAY: none" <? } ?> >
<tr>
...
<tbody id="hidden2" <? if(1==$setting['passport_type'] ) { ?> style="DISPLAY: none" <? } ?> >
<tr>
...
<td class="altbg2">
<input name="passport_credit1" value="1" <? if(1==$setting['passport_credit1'] ) { ?>checked<? } ?>  type="checkbox">经验值&nbsp;
<input name="passport_credit2" value="1" <? if(1==$setting['passport_credit2'] ) { ?>checked<? } ?>  type="checkbox">财富值
</td>
</tr>
</tbody>
</table>
