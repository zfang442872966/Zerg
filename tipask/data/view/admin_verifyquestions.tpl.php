...
</table><? } ?><table align="center" width="100%" cellspacing="1" cellpadding="4" class="tableborder">
    <tbody>
...
<? } } ?>
      <? if($departstr) { ?>        <tr class="smalltxt">
        ...
        <? } ?>        <tr>
            <td colspan="6" class="altbg1"><input class="btn" type="button" value="通过" onclick="verify()"/>&nbsp;&nbsp;&nbsp;<input class="btn" type="button" name="delete" value="删除" onclick="deleteanswer();" /></td>
        </tr>
    </table>
</form>
