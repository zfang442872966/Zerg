...
<br><? $adlist = $this->fromcache("adlist"); ?><form  action="index.php?admin_ad<?=$setting['seo_suffix']?>" method="post" name="indexform">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
        <tbody>
            <tr class="header">
                <td colspan="2"><span class="smalltxt"><a href="http://blog.tipask.com/archives/92" style="float:right;margin-top:10px;color:green" target="_blank">查看广告位布局</a></span>网站首页</td>
            </tr>
            <tr align="center">
...
<form  action="index.php?admin_ad<?=$setting['seo_suffix']?>" method="post" name="questionform">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
        <tbody>
            <tr class="header">
                <td colspan="2"><span class="smalltxt"><a href="http://blog.tipask.com/archives/92" style="float:right;margin-top:10px;color:green" target="_blank">查看广告位布局</a></span>问题查看页（待解决、已解决、已关闭）</td>
            </tr>
            <tr align="center">
...
<form  action="index.php?admin_ad<?=$setting['seo_suffix']?>"  method="post" name="categoryform">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
        <tbody>
            <tr class="header">
                <td colspan="2"><span class="smalltxt"><a href="http://blog.tipask.com/archives/92" style="float:right;margin-top:10px;color:green" target="_blank">查看广告位布局</a></span>分类浏览页</td>
            </tr>
            <tr align="center">
...
<form  action="index.php?admin_ad<?=$setting['seo_suffix']?>"  method="post" name="doingform">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
        <tbody>
            <tr class="header">
                <td colspan="2"><span class="smalltxt"><a href="http://blog.tipask.com/archives/92" style="float:right;margin-top:10px;color:green" target="_blank">查看广告位布局</a></span>问答动态</td>
            </tr>
            <tr align="center">
                <td class="altbg2">左边-广告位1<br>
...
<form  action="index.php?admin_ad<?=$setting['seo_suffix']?>"  method="post" name="doingform">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
        <tbody>
            <tr class="header">
                <td colspan="2"><span class="smalltxt"><a href="http://blog.tipask.com/archives/92" style="float:right;margin-top:10px;color:green" target="_blank">查看广告位布局</a></span>公告广告位页面（财富排行榜、问答公告、专家列表、知识专题、活跃用户）</td>
            </tr>
            <tr align="center">
                <td class="altbg2">左边-广告位1<br>
