<? if(!defined('IN_TIPASK')) exit('Access Denied'); include template(header,admin); $ipban=$this->ipban; ?><script src="js/jquery.js" type="text/javascript"></script>
...
</table><? } ?><form action="index.php?admin_banned/add<?=$setting['seo_suffix']?>" method="post">
...
<form method="post" action="index.php?admin_banned/remove.html" name="userForm">
    <table width="90%" cellspacing="1" cellpadding="4" border="0" class="tableborder">
...
<? if(is_array($iplist)) { foreach($iplist as $ip) { ?>
            <tr>
