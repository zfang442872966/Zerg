...
public class SendHttp {
	...
	public void sendGet(String geturi, List<NameValuePair> prarmeters, Header[] headers) throws ClientProtocolException, IOException, URISyntaxException {
	...
	public void sendPost(String posturi, List<NameValuePair> prarmeters, Header[] headers) throws IOException, URISyntaxException {
		CloseableHttpClient httpclient = HttpClients.createDefault();
		HttpHost proxy = new HttpHost("192.168.4.69", 8888);
		RequestConfig config = RequestConfig.custom().setProxy(proxy).build();
		try {
	...
	public final static void main(String[] args) throws Exception {
		...
		sendHttp.sendGet("http://mobile.ximalaya.com/m/category_tag_list", prarmeters, headers);
		...
		sendHttp.sendPost("http://mobile.ximalaya.com/mobile/message/in", postprar, psotheaders);
	}
}
