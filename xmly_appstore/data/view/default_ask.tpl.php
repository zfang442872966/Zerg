    ...
    <div class="content-left">
        <form enctype="multipart/form-data" method="POST" action="<?=SITE_URL?>?question/add.html" name="askform" id="askform" onsubmit="return check_form();" >
            <div class="askbox">
                ...
                <div class="inputbox">
                    <textarea class="qtitle" name="title" id="qtitle"><?=$word?></textarea>
        ...
        <? if($touser) { ?>        <div class="modbox">
            <div class="userinfo-box">
                <div class="userinfo clearfix">
                    ...
                    <h3><a href="<?=SITE_URL?>?u-<?=$touser['uid']?>.html" target="_blank" title="<?=$touser['username']?>"><? echo cutstr($touser['username'],20,'') ?></a></h3>
